...
*/
    unsigned long temp;
    GPIOPinWrite(GPIOA0_BASE, 0x80, 0); //Pin 62 for DC
    GPIOPinWrite(GPIOA3_BASE, 0x10, 0);//Pin 18 for OLEDCS write 0
    ...
    GPIOPinWrite(GPIOA3_BASE, 0x10, 0x10);//write 1
...
*/
    unsigned long temp ;
    GPIOPinWrite(GPIOA0_BASE, 0x80, 0x80); //Pin 62 for DC
    GPIOPinWrite(GPIOA3_BASE, 0x10, 0);//Pin 18 for OLEDCS (write 0)
    ...
    MAP_SPIDataGet(GSPI_BASE, &temp);
    MAP_SPICSDisable(GSPI_BASE);
    GPIOPinWrite(GPIOA0_BASE, 0x10, 0x10); //Write 1
